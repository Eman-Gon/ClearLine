...
internal suspend fun rawTreeMemoryProbe(key: String, database: String) {
    ...
    try {
        ...
        println("These four physical writes remain in the configured database; expected logical sessions=3.")
        ...
        repeat(3) { attempt ->
            ...
            if (fixture.matches(snapshot)) {
                println("PASS RawTree memory: 3 logical sessions after 4 writes; 2 prior calls; current call matched.")
